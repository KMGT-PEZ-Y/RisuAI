...
- 문서 버전: 1.0
- 확정일: 2026-09-01
- 구현 상태: Python Phase A-D 완료. 2026-09-04 M/U/H 30종과 공통 상태/할인/선택 제한 확장 구현. 상세는 `MUH_ACTIVE_SKILLS.md`.
...
- [x] NG+ 공용 평가·3턴 탐색, 자유 장착·판단 충실도 UI, 실제 실행기 일치·블라인드 선택 검증 (`NG_PLUS_AI.md`)
...
이후 같은 날 쉬움 적에 한정한 새 설계를 구현했다. `EASY_ENEMY_SKILLS.md`가 이번 구현의 수치·순번·실패 계약 기준이다. Player도 새 5종을 수동 선택할 수 있다. 전체 106개 테스트 통과 및 적별 1,000경기 비교 완료; 수치는 플레이테스트 초안이다.
